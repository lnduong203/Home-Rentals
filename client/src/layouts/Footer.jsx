...
const Footer = () => {
  return (
    <footer class=" w-full bg-rose-300">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto grid max-w-sm grid-cols-2 gap-3 gap-y-8 py-10 sm:max-w-3xl sm:grid-cols-4 md:gap-8 lg:max-w-full lg:grid-cols-6">
          <div class=" col-span-full mb-10 lg:col-span-2 lg:mb-0">
            <Link to="/" >
              <img src="/favicon.ico" alt="logo" className="w-28 mx-auto lg:mx-0" />
            </Link>
            <div className="pl-3">
              <p class="pb-5 pt-0 text-center text-sm text-gray-500 lg:max-w-xs lg:text-left">
                Trusted in more than 100 countries & 5 million customers. Have
                any query ?
              </p>
              <a
                href="/"
                class="mx-auto block h-9 w-fit rounded-full bg-rose-400 px-5 py-2.5 text-xs text-white shadow-sm transition-all duration-500 hover:bg-white hover:text-rose-400 lg:mx-0"
              >
                Contact us
              </a>
            </div>
          ...
          <div class="text-left lg:mx-auto  ">
            <h4 class="mb-7 text-lg font-medium text-gray-900">HomeHihi</h4>
          ...
          <div class="text-left lg:mx-auto">
            <h4 class="mb-7 text-lg font-medium text-gray-900">Support</h4>
            <ul class="text-sm transition-all duration-500">
              <li class="mb-6">
                <a href="/" class="text-gray-600 hover:text-gray-900">
                  Customer Support
          ...
          <div class="text-left lg:mx-auto">
            <h4 class="mb-7 text-lg font-medium text-gray-900">Subscribe</h4>
            <p class="mb-7 text-sm leading-6 text-gray-500">
              Subscribe to get the latest news from us
            </p>
            <a
              href="/"
              class="flex w-fit items-center justify-center gap-2 rounded-full border border-rose-400 px-6 py-3 text-sm font-semibold  transition-all duration-500 hover:bg-rose-400 text-white lg:mx-0"
            >
              Subscribe
              <svg
                width="15"
        ...
        <div class="border-t border-gray-200 py-7">
          <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
            <span class="text-sm text-gray-500">
              ©<a href="https://pagedone.io/">HomeHihi</a> 2024, All rights
              reserved.
            </span>
            <div class="mt-4 flex space-x-4 sm:justify-center lg:mt-0">
              <a
                href="/"
                class="flex h-8 w-8 items-center justify-center rounded-full bg-[#33CCFF] transition-all duration-500 hover:bg-gray-900"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <a
                href="/"
                class="relative flex h-8 w-8 items-center justify-center rounded-full bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)] from-gray-900 to-gray-900 transition-all duration-500 hover:bg-gradient-to-b"
              >
                <svg
                  class="h-[1.125rem] w-[1.25rem] text-white"
                  viewBox="0 0 16 16"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <a
                href="/"
                class="relative flex h-8 w-8 items-center justify-center rounded-full bg-[#337FFF] transition-all duration-500 hover:bg-gray-900"
              >
                <svg
              ...
              <a
                href="/"
                class="relative flex h-8 w-8 items-center justify-center rounded-full bg-[#FF0000] transition-all duration-500 hover:bg-gray-900"
              >
                <svg
                  class="h-[0.875rem] w-[1.25rem] text-white"
                  viewBox="0 0 16 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
